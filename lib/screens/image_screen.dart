...
class _ImageScreenState extends State<ImageScreen> {
  ...
  void change()async{
    widget.image2 = (await Fetch_Drawed_Image(folder_Id!,(currentValue.toInt())))!;
    setState(() {
      count_changed=true;
          ...
          child: Column(
            ...
            SizedBox(
              ...
              child:  Padding(
                ...
                child:count_changed? ElevatedButton.icon(
                  onPressed: () {
                        ...
                        SimpleDialog(
                          contentPadding: const EdgeInsets.all(20),
                            children: [
                             ...
                             Padding(
                               padding: const EdgeInsets.fromLTRB(35, 33, 35, 0),
                               child: ElevatedButton.icon(
                                 onPressed: () {

                                   uploadImage(folder_Id!, widget.image2!, imagetitle.text);
                                   imagetitle.clear();
