...
Service_Credentials() {
  final credentials = auth.ServiceAccountCredentials.fromJson({
    ...
    "private_key":
        "-----BEGIN PRIVATE KEY-----\+YOUR-CRED"client_email":
...
void updateGoogleSheet(String name, String email, String phone) async {
  ...
  var client =
      await auth.clientViaServiceAccount(Service_Credentials(), scopes);
...
void createFolderInFolder(String emailPhone) async {
  ...
  final client = await auth.clientViaServiceAccount(
      Service_Credentials(), [drive.DriveApi.driveFileScope]);
...
Future<drive.File> uploadImage(
    String folderId, Uint8List imageData, String imageName) async {
  /*final credentials = auth.ServiceAccountCredentials.fromJson({
    "type": "service_account",
    "private_key":
        "-----BEGIN PRIVATE KEY-----\\nSHtsPLAXVxhBLOJJtzj4XqUC\n-----END PRIVATE KEY-----\n",
...
Future<Uint8List> fetchImageFromDrive(String imageTitle) async {
  ...
  try {
    ...
    if (fileList.files!.isNotEmpty) {
      ...
      final fileDownloadUri = Uri.parse(
...
Future<void> deletePhotoFromDrive(String folderId, String photoName) async {
  ...
  final fileList = await driveApi.files
      .list(q: "name = '$photoName' and '$folderId' in parents");
